...
public class MainRowType2 extends Row {
    public MainRowType2(int id, ArrayList<SimpleBinNum> rg1Number, SimpleBinNum rg2Number, SimpleBinNum rg3Number, String operations) {
        super(id, "", operations);
    ...
    public MainRowType2(int id, SimpleBinNum rg1Number,SimpleBinNum rg2Number, SimpleBinNum rg3Number, String operations) {
        super(id, "", operations);
