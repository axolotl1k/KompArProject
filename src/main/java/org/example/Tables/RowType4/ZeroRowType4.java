...
public class ZeroRowType4 extends MainRowType4{
    public ZeroRowType4(int id, SimpleBinNum rg1Number, SimpleBinNum rg2Number, SimpleBinNum rg3Number, String operations) {
